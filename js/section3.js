...
var swiper = new Swiper('.swiper-container', {
  ...
  var audio;
  var audioTab =[];
  var audio1 = new Audio('mp3/section-3/histography.mp3');
  var audio2 = new Audio('mp3/section-3/lostalgic.mp3');
  var audio3 = new Audio('mp3/section-3/love-of-guns.mp3');
  var audio4 = new Audio('mp3/section-3/one-angry-bird.mp3');
  var audio5 = new Audio('mp3/section-3/earth-insights.mp3');
  ...
  audioTab.push(audio1,audio2, audio3, audio4, audio5);
  audioTab[0].muted=true;
  audioTab[1].muted=true;
  audioTab[2].muted=true;
  audioTab[3].muted=true;
  audioTab[4].muted=true;
  dureeAudio.push(dureeAudio1, dureeAudio2, dureeAudio3, dureeAudio4, dureeAudio5)
  ...
  //--------------------------------------------------------------------------
    ...
    if (nbLiAllClass >= 7){  // si clic sur li 2 ds la page

      nbLiAllClass = nbLiAllClass - 7
    ...
    else if (nbLiAllClass < 7){ // clic sur li hors page
      ...
      console.log(liAll[nbLiAllClass].innerHTML)
      ...
      barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(nbLiAllClass+1)*0.2}) scaleY(1)`
  ...
  function moveBt() {
    ...
    if (nbBtAllClass == 1){ // si clic sur next
      ...
      barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(attrSlider+2)*0.2}) scaleY(1)`
    ...
    barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(attrSlider)*0.2}) scaleY(1)`
    }
    }
