...
var swiper = new Swiper('.swiper-container', {
  ...
  var audio;
  var audioTab =[];
  var audio1 = new Audio('mp3/section-2/Disease squeeze.mp3');
  var audio2 = new Audio('mp3/section-2/sounds-like-trouble-cut.mp3');
  var audio3 = new Audio('mp3/section-2/Trillions of Trees.mp3');
  var audio4 = new Audio('mp3/section-2/facebook-algorithmic.mp3')
  ...
  audioTab.push(audio1,audio2, audio3, audio4);
  audioTab[0].muted=true;
  audioTab[1].muted=true;
  audioTab[2].muted=true;
  audioTab[3].muted=true;
  dureeAudio.push(dureeAudio1, dureeAudio2, dureeAudio3, dureeAudio4)
  ...
  //--------------------------------------------------------------------------
    ...
    if (nbLiAllClass >= 3 && nbLiAllClass <= 6){  // si clic sur li 2 ds la page

      nbLiAllClass = nbLiAllClass - 3
    ...
    else if (nbLiAllClass < 3 || nbLiAllClass > 6 ){ // clic sur li hors page
    ...
    if (nbLiAllClass != 0){
      ...
      barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(nbLiAllClass+1)*0.25}) scaleY(1)`
  ...
  function moveBt() {
    ...
    if (nbBtAllClass == 1){ // si clic sur next
      ...
      barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(attrSlider+2)*0.25}) scaleY(1)`
    ...
    barreProgression.style.transform =`translate3d(0px, 0px, 0px) scaleX(${(attrSlider)*0.25}) scaleY(1)`
    }
    }
